...
try{  
    ...
    PreparedStatement ps1=con1.prepareStatement("select * from approve_milk where cust_id=?");  
 ...
 <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <tr>
                                                <th><%=rs1.getInt(1)%></th>
                                                <th><%=rs1.getString(2)%>   approved</th>
                                                
                                                
                                            <th><a href="okay?cust_id=<%=rs1.getInt(1)%>">Okay</a></th>
                                            </tr>
